...
function App()
{
    ...
    //A LINE NOBODY IS LOOKING AT, PUT WHERE THEY WILL SEE IT. IT IS EVERY PLATFORM'S QUESTION AND THE SAME
    //ONE ON ALL OF THEM - A PHONE WITH THE APP OFF SCREEN AND A DESKTOP WITH ITS WINDOW IN THE TRAY ARE BOTH
    //A SESSION RUNNING WITH NOBODY WATCHING IT - AND ONLY **HOW** IT IS POSTED IS THE PLATFORM'S OWN
    //(notify_message). IT IS ASKED HERE BECAUSE THIS SIDE IS THE ONLY ONE THAT KNOWS **WHERE** A LINE LANDED
    //AND WHERE ANYBODY IS READING: THE BRIDGE FILES EVERY MESSAGE INTO WHATEVER PANE IS CURRENT AND HAS NO
