...
# OUR FOUR CLASSES IS android.rs THROUGH loadClass AND CallStaticMethod - A STRING AND NOT A REFERENCE,
# SO A CLASS NOTHING ELSE NAMES IS ONE R8 IS RIGHT TO BELIEVE IS DEAD. THE ACTIVITY AND THE SERVICE ARE
# NAMED IN THE MANIFEST AND SURVIVE ON THAT ALONE; AudioRoute AND ImageStore ARE NAMED NOWHERE BUT HERE,
